...
//
// Params
//    battery_3dmodel_filename: default is ''
...
//    battery_3dmodel_xyz_offset: default is [0, 0, 0]
//      xyz offset (in mm), used to adjust the position of the 3d model
//      relative the footprint.
//    battery_3dmodel_xyz_scale: default is [1, 1, 1]
...
module.exports = {
  params: {
    battery_3dmodel_filename: '',
    battery_3dmodel_xyz_offset: [0, 0, 0],
    battery_3dmodel_xyz_rotation: [0, 0, 0],
    battery_3dmodel_xyz_scale: [1, 1, 1],
    designator: 'JST',
    side: 'F',
    reversible: false,
    include_traces: true,
  ...
  body: p => {
    ...
    (model ${p.battery_3dmodel_filename}
      (offset (xyz ${p.battery_3dmodel_xyz_offset[0]} ${p.battery_3dmodel_xyz_offset[1]} ${p.battery_3dmodel_xyz_offset[2]}))
      (scale (xyz ${p.battery_3dmodel_xyz_scale[0]} ${p.battery_3dmodel_xyz_scale[1]} ${p.battery_3dmodel_xyz_scale[2]}))
      (rotate (xyz ${p.battery_3dmodel_xyz_rotation[0]} ${p.battery_3dmodel_xyz_rotation[1]} ${p.battery_3dmodel_xyz_rotation[2]}))
    )
    `
