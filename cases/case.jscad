...
.subtract(
    new CSG.Path2D.arc({"center":[191.5050981,-104.7601542],"radius":1,"startangle":64.025626,"endangle":108.3913756}).appendPoint([191.0446752,-103.4229891]).appendPoint([191.9430672,-103.8611642]).close().innerToCAG()
.union(
